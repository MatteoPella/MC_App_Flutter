...
class CatCasuale extends StatefulWidget {
  const CatCasuale({Key? key}) : super(key: key);

  @override
  _CatCasualeState createState() => _CatCasualeState();
}

class _CatCasualeState extends State<CatCasuale>
